...
![封面：两种工作模式 — Scatter 和 Laser — 以及在两者之间做选择的人](imgs/cover.png)
...
![10 倍陷阱：更多产出，更少清晰度，不断累积的疲劳](imgs/01-10x-trap.png)
...
![研究数据：AI 加剧了工作强度，而非减轻了它](imgs/02-research.png)
...
![Kahneman 的系统 1 和系统 2，对应到 AI 工作模式](imgs/03-kahneman.png)
...
![两种模式：Scatter（并行、广度、AI 赋能）vs Laser（串行、深度、人类主导）](imgs/04-two-modes.png)
...
![每日实践：上午 Scatter，下午 Laser，中间有切换仪式](imgs/05-daily-practice.png)
...
![不变的是你：你选择模式](imgs/06-the-constant.png)
