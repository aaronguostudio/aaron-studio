...
![我用 AI 工程化了吸引力法则](imgs/web/00-cover.webp)
...
![RAS：意图如何重新编程你大脑的过滤器，从每秒 1100 万比特降到约 40 比特](imgs/web/04-infographic-ras-mechanism.webp)
...
![吸引力法则 vs 推荐算法——同一个四步结构](imgs/web/01-comparison-loa-vs-algorithm.webp)
...
![Signal 系统架构——信息源、AI 打分和晨间摘要](imgs/web/02-framework-signal-architecture.webp)
...
![注意力经济 vs 意图经济——算法在为谁服务？](imgs/web/05-comparison-attention-vs-intention.webp)
...
![Signal 飞轮——Signal → 知识 → 行动 → Signal](imgs/web/03-flowchart-signal-flywheel.webp)
...
*关注我，获取更多关于构建服务你意图——而非算法意图——的 AI 系统的内容。*
