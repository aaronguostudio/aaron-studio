# What a Marriott Timeshare Pitch in Las Vegas Taught Me About Broken Sales Culture
...
![The timeshare model — money flows in, but there's no clear way out](imgs/01-infographic-timeshare-structure.png)
...
![The pressure moment — 30 minutes to decide your financial future](imgs/02-scene-pressure-moment.png)
...
![Four revenue engines of the timeshare business model](imgs/03-infographic-revenue-engines.png)
...
![Short-term sales wins versus long-term brand damage](imgs/04-comparison-sales-impact.png)
...
![Service culture versus sales culture — the gap that breaks trust](imgs/05-comparison-service-vs-sales.png)
