...
![Cover: The evolution of creative tools — from camera to AI — with the constant: human taste](imgs/cover.png)
...
![The same pattern repeating: each new tool lowers the floor, but never raises the ceiling](imgs/01-pattern-history.png)
...
[Placeholder: AI-generated video/image examples — showing both raw AI output and the polished final version to illustrate the gap]

The gap between "AI generated this" and "this is genuinely good" is still filled by the human.

![The effort shifted: less execution, more judgment and curation](imgs/02-effort-shift.png)
...
![AI slop: when the tool becomes the product, quality disappears](imgs/03-ai-slop.png)
...
![The headline says "AI beats humans" — the data tells a different story](imgs/04-hype-vs-data.png)
...
![AI is an amplifier: what you bring in determines what comes out](imgs/05-amplifier.png)
