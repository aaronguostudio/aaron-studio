...
![一只手把尚未定案的代码纸带送过权威边界，使它成为业务信任的记录](imgs/web/00-cover.webp)
...
![代码已经撤回，但权威记录里的错误状态仍然传播到了三个下游记录](imgs/web/01-authority-ripple.webp)
...
![修改越接近权威状态，审查就从结果逐层深入到证据、系统模型和关键路径](imgs/web/02-review-depth-ladder.webp)
