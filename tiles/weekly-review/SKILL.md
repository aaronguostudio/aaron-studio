...
5. **Privacy.** Per the repo agent guide ([AGENTS.md](../../AGENTS.md) / [CLAUDE.md](../../CLAUDE.md)), `brain/` content is private. If using web search, search ABOUT topics ("AI-native firm management trends Q2 2026"), never paste private observations or names into queries.
...
```
Aaron: weekly review, and check what's happening with agent SDKs — I've been building on them

Skill:
  1. Scope: current week.
  2. Same internal gathering.
  3. Top theme: agent SDK work.
  4. WebSearch: "agent SDK April 2026 updates".
